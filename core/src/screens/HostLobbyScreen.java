...
public class HostLobbyScreen extends Screen {
    ...
    public void render(SpriteBatch sb) {
        ...
        playersJoinedText.draw(sb,
                ...
                (float)(width * 0.16),
                (float)(height * 0.51));
        player1Text.draw(sb, players.get(0), (float)(width * 0.16), (float)(height * 0.4));
        player2Text.draw(sb, players.get(1), (float)(width * 0.16), (float)(height * 0.3));
        player3Text.draw(sb, players.get(2), (float)(width * 0.16), (float)(height * 0.2));
        player4Text.draw(sb, players.get(3), (float)(width * 0.16), (float)(height * 0.1));
        sb.end();
    }
